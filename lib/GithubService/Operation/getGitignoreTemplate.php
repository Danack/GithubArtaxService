...
class getGitIgnoreTemplate implements \ArtaxServiceBuilder\Operation {
    ...
    public function __construct(\GithubService\GithubArtaxService\GithubArtaxService $api, \GithubService\AuthToken $authorization, $userAgent, $type) {
        $defaultParams = [
     ...
     *
     * @return \GithubService\Model\Template
    ...
    public function createRequest() {
        ...
        if ($url == null) {
            $url = "https://api.github.com/gitignore/templates/{type}";
        }
     ...
     *
     * @return mixed|\GithubService\Model\Template
     */
    ...
    public function getResultInstantiationInfo() {
        return ['instantiate' => 'GithubService\\Model\\Template'];
    }
