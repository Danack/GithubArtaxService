...
class getOrCreateAuthorizationForAppFingerprint implements \ArtaxServiceBuilder\Operation {
    ...
    public function __construct(\GithubService\GithubArtaxService\GithubArtaxService $api, $client_secret, $scopes, $note, $note_url, $fingerprint) {
        $this->api = $api;
    ...
    public function createRequest() {
        ...
        if ($url == null) {
            $url = "https://api.github.com/authorizations/clients/{client_id}/{fingerprint}";
        }
        $request->setUri($url);
