...
class getGistByRevision implements \ArtaxServiceBuilder\Operation {
     ...
     *
     * @return \GithubService\Model\FullGist
    ...
    public function createRequest() {
        ...
        if ($url == null) {
            $url = "https://api.github.com/gists/{id}/{sha}";
        }
     ...
     *
     * @return mixed|\GithubService\Model\FullGist
     */
    ...
    public function getResultInstantiationInfo() {
        return ['instantiate' => 'GithubService\\Model\\FullGist'];
    }
