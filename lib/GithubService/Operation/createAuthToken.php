...
class createAuthToken implements \ArtaxServiceBuilder\Operation {
    ...
    public function __construct(\GithubService\GithubArtaxService\GithubArtaxService $api, $Authorization, $userAgent, $scopes, $note, $note_url) {
        $defaultParams = [
