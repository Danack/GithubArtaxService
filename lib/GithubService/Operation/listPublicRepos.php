...
class listPublicRepos implements \ArtaxServiceBuilder\Operation {
    ...
    public function __construct(\GithubService\GithubArtaxService\GithubArtaxService $api, \GithubService\AuthToken $authorization, $userAgent, $since) {
        $defaultParams = [
    ...
    public function getResultInstantiationInfo() {
        return ['instantiate' => 'GithubService\\Model\\RepoSimpleList'];
    }
