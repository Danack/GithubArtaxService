...
class compareTwoCommitsForks implements \ArtaxServiceBuilder\Operation {
    ...
    public function __construct(\GithubService\GithubArtaxService\GithubArtaxService $api, \GithubService\AuthToken $authorization, $userAgent) {
        $defaultParams = [
     ...
     *
     * @return \GithubService\Model\CommitComparison
    ...
    public function createRequest() {
        ...
        if ($url == null) {
            $url = "https://api.github.com/repos/{owner}/{repo}/compare/{hubot}:{branchname}...{octocat}:{branchname}";
        }
     ...
     *
     * @return mixed|\GithubService\Model\CommitComparison
     */
    ...
    public function getResultInstantiationInfo() {
        return ['instantiate' => 'GithubService\\Model\\CommitComparison'];
    }
