...
class listRepoContributors implements \ArtaxServiceBuilder\Operation {
    ...
    public function __construct(\GithubService\GithubArtaxService\GithubArtaxService $api, \GithubService\AuthToken $authorization, $userAgent, $owner, $repo, $anon) {
        $defaultParams = [
     ...
     *
     * @return \GithubService\Model\Contributor
     ...
     *
     * @return mixed|\GithubService\Model\Contributor
     */
