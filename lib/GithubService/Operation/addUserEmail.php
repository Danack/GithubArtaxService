...
class addUserEmail implements \ArtaxServiceBuilder\Operation {
    ...
    public function __construct(\GithubService\GithubArtaxService\GithubArtaxService $api, \GithubService\AuthToken $authorization, $userAgent, \string or array $username) {
        $defaultParams = [
     ...
     * Set username
     *
     * A single email address or an array of addresses
     *
     * @return $this
     */
    public function setUsername(\string or array $username) {
        $this->parameters['username'] = $username;
     ...
     *
     * @return \GithubService\Model\UserEmail
     ...
     *
     * @return mixed|\GithubService\Model\UserEmail
     */
    ...
    public function getResultInstantiationInfo() {
        return ['instantiate' => 'GithubService\\Model\\UserEmail'];
    }
