...
class listOrgRepos implements \ArtaxServiceBuilder\Operation {
    ...
    public function __construct(\GithubService\GithubArtaxService\GithubArtaxService $api, $authorization, $userAgent, $org, $type) {
        $defaultParams = [
    ...
    public function call() {
        ...
        if ($this->shouldResponseBeProcessed($response)) {
            $instance = \GithubService\Model\Repos::createFromResponse($response, $this);
