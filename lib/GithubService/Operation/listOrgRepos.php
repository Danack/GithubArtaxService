...
class listOrgRepos implements \ArtaxServiceBuilder\Operation {
    ...
    public function __construct(\GithubService\GithubArtaxService\GithubArtaxService $api, \GithubService\AuthToken $authorization, $userAgent, $org, $type) {
        $defaultParams = [
    ...
    public function setParams(array $params) {
        ...
        if (array_key_exists('org', $params)) {
            $this->parameters['org'] = $params['org'];
        }
     ...
     * Set org
     *
     * The organisation to get the repos of.
     *
     * @return $this
     */
     ...
     * Set type
     *
     * Can be one of `all`, `public`, `private`, `forks`, `sources`, `member`. Default:
     * `all`
     *
     * @return $this
     */
     ...
     *
     * @return \GithubService\Model\Repos
    ...
    public function createRequest() {
        ...
        $value = $this->getFilteredParameter('org');
        $queryParameters['org'] = $value;
     ...
     *
     * @return mixed|\GithubService\Model\Repos
     */
    ...
    public function getResultInstantiationInfo() {
        return ['instantiate' => 'GithubService\\Model\\Repos'];
    }
