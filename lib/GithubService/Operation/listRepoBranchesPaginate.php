...
class listRepoBranchesPaginate implements \ArtaxServiceBuilder\Operation {
     ...
     *
     * @return \GithubService\Model\RepoBranches
     ...
     *
     * @return mixed|\GithubService\Model\RepoBranches
     */
    public function call() {
        ...
        if ($this->shouldResponseBeProcessed($response)) {
            $instance = \GithubService\Model\RepoBranches::createFromResponse($response, $this);
