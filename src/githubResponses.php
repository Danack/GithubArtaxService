...
$CONTRIBUTOR = array_merge($USER,[
  "contributions" => 32
]);

$FULL_USER = array_merge($USER, [
...
$PRIVATE_USER = array_merge($FULL_USER, [
...
$PUBLIC_KEY = array_merge($SIMPLE_PUBLIC_KEY, [
...
$FULL_REPO = array_merge($REPO, [
  "subscribers_count" => 42,
  "organization"      => array_merge($USER, ['type' => 'Organization']),
  "parent"            => $REPO,
  "source"            => $REPO
]);
...
$FULL_COMMIT = array_merge($COMMIT, [
  "stats" => [
"additions" => 104,
    "deletions" => 4,
    "total"     => 108,
...
$CREATED_RELEASE = array_merge($RELEASE, [
  "assets"         => []
]);
...
$CREATE_DOWNLOAD = array_merge($DOWNLOAD, [
  "policy"         => "ewogICAg...",
  "signature"      => "mwnFDC...",
  "bucket"         => "github",
...
$PRIVATE_ORG = array_merge($FULL_ORG, [
  "total_private_repos" => 100,
  "owned_private_repos" => 100,
  "private_gists"       => 81,
  "disk_usage"          => 10000,
...
$ACTIVE_TEAM_MEMBERSHIP = array_merge($TEAM_MEMBERSHIP, 
["state" => "active"]
);

$PENDING_TEAM_MEMBERSHIP = array_merge($TEAM_MEMBERSHIP, 
    ["state" => "pending"]
);
...
$FULL_ISSUE_EVENT = array_merge($ISSUE_EVENT, ['issue' => $ISSUE]);
...
$OAUTH_ACCESS_WITH_USER = array_merge($OAUTH_ACCESS, ['user' => $USER]);
...
$STATUS = array_merge($SIMPLE_STATUS, 
    ["creator" => $USER]
);
...
"state" => "success",
  ...
  "total_count" => 2,
  "statuses" => [
    array_merge($SIMPLE_STATUS, ["context" => "continuous-integration/jenkins"]),
    array_merge($SIMPLE_STATUS, ["context" => "security/brakeman"])
  ],
...
$REPO_SUBSCRIPTION = array_merge($SUBSCRIPTION, [
    "url" => "https://api.github.com/repos/octocat/example/subscription",
  "repository_url" => "https://api.github.com/repos/octocat/example"
]);

unset($REPO_SUBSCRIPTION['thread_url']);
