...
$PRIVATE_USER = array_merge(
    ...
    [
        ...
        "plan" => [
            ...
            "private_repos" => 20,
            "collaborators" => 0
            # Plans now allow *unlimited* collaborators, so
...
$ACTIVE_TEAM_MEMBERSHIP = array_merge(
    $TEAM_MEMBERSHIP,
    ["state" => "active"]
);

$PENDING_TEAM_MEMBERSHIP = array_merge(
    $TEAM_MEMBERSHIP,
    ["state" => "pending"]
);
