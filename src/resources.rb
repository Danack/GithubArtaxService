...
JSONS = {
    ...
    "SIMPLE_PUBLIC_KEY" => SIMPLE_PUBLIC_KEY, 
    "PUBLIC_KEY" => PUBLIC_KEY, 
    "SIMPLE_REPO" => SIMPLE_REPO, 
    ...
    "PENDING_TEAM_MEMBERSHIP" => PENDING_TEAM_MEMBERSHIP, 
    "USER_FOR_ORG_MEMBERSHIP" => USER_FOR_ORG_MEMBERSHIP,
    "ORG_FOR_ACTIVE_ORG_MEMBERSHIP" => ORG_FOR_ACTIVE_ORG_MEMBERSHIP,
    "ORG_FOR_PENDING_ORG_MEMBERSHIP" => ORG_FOR_PENDING_ORG_MEMBERSHIP,
    "ACTIVE_ADMIN_ORG_MEMBERSHIP" => ACTIVE_ADMIN_ORG_MEMBERSHIP,
    "ACTIVE_LIMITED_ORG_MEMBERSHIP" => ACTIVE_LIMITED_ORG_MEMBERSHIP,
    "PENDING_ADMIN_ORG_MEMBERSHIP" => PENDING_ADMIN_ORG_MEMBERSHIP,
    "PENDING_LIMITED_ORG_MEMBERSHIP" => PENDING_LIMITED_ORG_MEMBERSHIP,
    "ORG_MEMBERSHIPS" => ORG_MEMBERSHIPS, 
    "ACTIVE_ORG_MEMBERSHIPS " => ACTIVE_ORG_MEMBERSHIPS, 
    ...
    "FULL_ISSUE_EVENT" => FULL_ISSUE_EVENT, 
    "ISSUE_SEARCH_ITEM" => ISSUE_SEARCH_ITEM, 
    "ISSUE_SEARCH_RESULTS" => ISSUE_SEARCH_RESULTS, 
    "ISSUE_SEARCH_V3_RESULTS" => ISSUE_SEARCH_V3_RESULTS, 
    "ISSUE_SEARCH_V3_RESULTS_HIGHLIGHTING" => ISSUE_SEARCH_V3_RESULTS_HIGHLIGHTING, 
    "REPO_SEARCH_ITEM" => REPO_SEARCH_ITEM, 
    "REPO_SEARCH_RESULTS" => REPO_SEARCH_RESULTS, 
    "REPO_SEARCH_V3_RESULTS" => REPO_SEARCH_V3_RESULTS, 
    "REPO_SEARCH_V3_RESULTS_HIGHLIGHTING" => REPO_SEARCH_V3_RESULTS_HIGHLIGHTING, 
    "CODE_SEARCH_V3_RESULTS" => CODE_SEARCH_V3_RESULTS, 
    "CODE_SEARCH_V3_RESULTS_HIGHLIGHTING" => CODE_SEARCH_V3_RESULTS_HIGHLIGHTING, 
    "USER_SEARCH_ITEM" => USER_SEARCH_ITEM, 
    "USER_SEARCH_RESULTS" => USER_SEARCH_RESULTS, 
    "USER_SEARCH_V3_RESULTS" => USER_SEARCH_V3_RESULTS, 
    "USER_SEARCH_V3_RESULTS_HIGHLIGHTING" => USER_SEARCH_V3_RESULTS_HIGHLIGHTING, 
    "EMAIL_SEARCH_RESULTS" => EMAIL_SEARCH_RESULTS, 
    "GIST_HISTORY" => GIST_HISTORY, 
    "GIST_FORKS" => GIST_FORKS, 
    "GIST_FILE" => GIST_FILE, 
    "GIST_FILE_WITH_CONTENT" => GIST_FILE_WITH_CONTENT, 
    "GIST" => GIST, 
    "FULL_GIST" => FULL_GIST, 
    ...
    "OAUTH_ACCESS_WITH_USER" => OAUTH_ACCESS_WITH_USER, 
    "EVENT" => EVENT, 
    ...
    "META" => META, 
    "BLOB" => BLOB, 
    "BLOB_AFTER_CREATE" => BLOB_AFTER_CREATE, 
    ...
    "REPO_STATS_CONTRIBUTORS" => REPO_STATS_CONTRIBUTORS, 
    "REPO_STATS_COMMIT_ACTIVITY" => REPO_STATS_COMMIT_ACTIVITY, 
    "REPO_STATS_CODE_FREQUENCY" => REPO_STATS_CODE_FREQUENCY, 
    "REPO_STATS_PARTICIPATION" => REPO_STATS_PARTICIPATION, 
    "REPO_STATS_PUNCH_CARD" => REPO_STATS_PUNCH_CARD, 
    "FEEDS" => FEEDS, 
    "EMOJIS" => EMOJIS, 
    ...
    "GET_AUTHORIZED_SSH_KEYS" => GET_AUTHORIZED_SSH_KEYS, 
}

require 'json'

JSONS.each do |key, value|
  file = File.open("../test/fixtures/data/githubJSON/#{key}.json", "w")
