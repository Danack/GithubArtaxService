...
//        $scopes = [
//            \ArtaxServiceBuilder\Service\Github::SCOPE_USER_EMAIL,
//            \ArtaxServiceBuilder\Service\Github::SCOPE_ORG_READ,
...
function showScopesForm() {
    ...
    foreach (\ArtaxServiceBuilder\Service\Github::$scopeList as $scope => $description) {
